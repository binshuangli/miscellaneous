...
for seq_record in SeqIO.parse("/Users/Jason/Documents/aphicarus/biotypes/9w_351389.fasta", "fasta"):
...
for seq_record in SeqIO.parse("/Users/Jason/Documents/aphicarus/biotypes/14wl_351389.fasta", "fasta"):
    for i in range(0,length):
        if seq_record.seq[i]=="A" or seq_record.seq[i]=="a":
            WL_count_A[i]+=1
        elif seq_record.seq[i]=="T" or seq_record.seq[i]=="t":
            ...
            WL_count_N[i]+=1
print (W_count_A[0:11])
print (WL_count_A[0:11])
...
dftr=df.transpose()
dftr.to_csv("/Users/Jason/Desktop/9w14wl_351389_data.csv",header=False,index=False)